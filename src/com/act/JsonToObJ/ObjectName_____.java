...
public class ObjectName_____ {
    ...
    private KeyPropertyList_____ keyPropertyList;
    @JsonProperty("domain")
    ...
    @JsonProperty("keyPropertyList")
    public KeyPropertyList_____ getKeyPropertyList() {
        return keyPropertyList;
    }

    @JsonProperty("keyPropertyList")
    public void setKeyPropertyList(KeyPropertyList_____ keyPropertyList) {
