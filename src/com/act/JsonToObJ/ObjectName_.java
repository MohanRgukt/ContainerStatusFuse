...
public class ObjectName_ {
    ...
    private KeyPropertyList_ keyPropertyList;
    @JsonProperty("domain")
    ...
    @JsonProperty("keyPropertyList")
    public KeyPropertyList_ getKeyPropertyList() {
        return keyPropertyList;
    }

    @JsonProperty("keyPropertyList")
    public void setKeyPropertyList(KeyPropertyList_ keyPropertyList) {
