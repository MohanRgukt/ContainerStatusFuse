...
public class ObjectName__ {
    ...
    private KeyPropertyList__ keyPropertyList;
    @JsonProperty("domain")
    ...
    @JsonProperty("keyPropertyList")
    public KeyPropertyList__ getKeyPropertyList() {
        return keyPropertyList;
    }

    @JsonProperty("keyPropertyList")
    public void setKeyPropertyList(KeyPropertyList__ keyPropertyList) {
