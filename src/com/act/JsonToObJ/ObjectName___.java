...
public class ObjectName___ {
    ...
    private KeyPropertyList___ keyPropertyList;
    @JsonProperty("domain")
    ...
    @JsonProperty("keyPropertyList")
    public KeyPropertyList___ getKeyPropertyList() {
        return keyPropertyList;
    }

    @JsonProperty("keyPropertyList")
    public void setKeyPropertyList(KeyPropertyList___ keyPropertyList) {
